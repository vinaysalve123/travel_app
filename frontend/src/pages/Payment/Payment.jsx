...
const Payment = () => {
    ...
    (async () => {
      try {
        const { data } = await axios.get(
          `https://travel-app-onjk.onrender.com/api/hotels/${id}`
        );
        setSingleHotel(data);
      } catch (err) {
        console.log(err);
  ...
  const handleConfirmBookingClick = async () => {
    ...
    const options = {
      key: "rzp_test_2iUnQWowB2WqJs",
      amount: totalPayableAmount * 100,
      currency: "INR",
      name: "TravelOp",
      email: "vinaysalve@gmail.com",
      contact: "9876543210",
      ...
      <main className="payment-page d-flex justify-center">
        ...
        <div className="final-details d-flex direction-column gap-large">
          ...
          <div className="tag">
            ...
            <strong className="strong">TravelOp</strong> cover
          </div>
...
//                         </div>
//                     </div>
//                     <div className="d-fex direction-column gap-sm">
//                         <h3>Pay With</h3>
//                         <div>Razorpay</div>
//                     </div>
...
//                 <div className="final-details d-flex direction-column gap-large">
//                     <div className="d-flex gap-sm">
//                         <img className="image" alt="hotel_img"/>
//                         <div className="d-flex direction-column">
//                             <div className="d-flex direction-column grow-shrik-basis">
//                                 <span>Sukoon Bag</span>
//                                 <span>Beed, Maharashtra</span>
//                             </div>
//                             <div className="rating-container">
//                                 <span className="rating d-flex align-center">
//                                     <span className="material-icons-outlined">star</span>
...
//                     </div>
//                     <div className="tag">
//                         Your Booking is protected by <strong className="strong">TravelOp</strong> cover
//                     </div>
//                     <div className="price-detail-container">
//                         <div className="price-distribution d-flex direction column">
//                             <h3>Price Details</h3>
//                             <div className="final-price d-flex align-center justify-space-between">
//                                 <span className="span">Rs. 2500 * 2 nights</span>
...
//                             <div className="final-price d-flex align-center justify-space-between">
//                                 <span className="span">Total</span>
//                                 <span className="span">Rs. 5150</span>
//                             </div>
//                         </div>
//                     </div>
//                 </div>
